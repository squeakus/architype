...
def mutant():
  ...
  def arm_strut(connectors, t):
      print "createArm:", connectors
      startpoint = arm(t)
      top_point = g.node[connectors[0]]['xyz']
      base_point = g.node[connectors[1]]['xyz']
      triangle = [startpoint, top_point, base_point]
      line_id = g.add_unique_node(startpoint, 'line')
      g.varinski(triangle, "arm", [1,2,1,2])
      #g.sierpinski(triangle,3)
